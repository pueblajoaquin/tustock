...
| RN-27 | Superar el límite de crédito genera advertencia, nunca bloqueo.                                                                                          | Es un kiosco de barrio: el dueño decide, no el sistema.                                      |
...
| ------ | --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RNF-01 | Velocidad de venta          | Confirmar una venta de 10 ítems responde en menos de 500 ms (percentil 95) en la PC objetivo del kiosco.                                                                                                                          |
